...
//open the atmFrame(atmFrame) after login sucessfully
atmFrame atm = new atmFrame();
atm.setVisible(true);//show the atmFrame
//for closing login frame
this.dispose();
}
else {
        JOptionPane.showMessageDialog(this, "Login failed try agian.");
    ...
    private static class textFieldUsername {
